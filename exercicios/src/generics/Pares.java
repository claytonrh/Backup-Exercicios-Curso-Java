...
public class Pares <C extends Number, V>  {
	...
	private final Set <Par<C, V>> itens = new LinkedHashSet<>();
	  // a função Set não aceita repetições
	
	public void adicionar(C chave, V valor) {
		//if(chave != null) * esta seria a forma mais comum de garantir
//		que o método apenas seja executado se o valor de chave ñ for null
		if (chave == null) return;  // neste outro exemplo vo manda sair do método			
